-- Migration 004: push notification blast feature
...
COMMENT ON TABLE notification_blasts IS 'A push notification batch composed and sent from the admin backoffice';
